                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-auto">
                                    <div class="d-flex align-items-center bg-dark rounded p-1">
                                        <button class="btn btn-sm btn-dark" @click="decrementQuantity(index)"
    ...
    methods: {
        ...
        removeItem(index) {
            ...
            if (confirm('Apakah Anda yakin ingin menghapus item ini?')) {
                try {
                    // API call to delete the item from the server
        ...
        async deleteSelected() {
            if (confirm('Apakah Anda yakin ingin menghapus item yang dipilih?')) {
                try {
                    ...
                    console.error('Gagal menghapus item yang dipilih:', error);
                }
            }
        },
        checkout() {
