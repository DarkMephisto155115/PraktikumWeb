<template>
  <div id="app" class="bg-dark">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark" v-if="!isLoginPage && !isRegisterPage && !isAdminPage">
      <div class="container">
        <img style="height: 100px;" src="../public/terra_brain_logo.png" alt="">
        <router-link class="navbar-brand" to="/">TERRA-BRAIN STORE</router-link>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 d-flex align-items-center">
        <img style="height: 100px; margin-right: 15px;" src="../public/terra_brain_logo.png" alt="TERRA-BRAIN Logo">
        <div>
          <h5 class="text">TERRA-BRAIN STORE</h5>
          <p>The Best Computer Shop</p>
        </div>
      </div>
      <div class="col-md-6 text-md-end">
        <p>&copy; 2024 TERRA-BRAIN All rights reserved.</p>
      </div>
    </div>
  </div>
</footer>
